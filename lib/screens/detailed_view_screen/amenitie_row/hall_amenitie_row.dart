...
class HallAmenitieRow extends StatefulWidget {
  const HallAmenitieRow({super.key});

  @override
  State<HallAmenitieRow> createState() => _HallAmenitieRowState();
}

class _HallAmenitieRowState extends State<HallAmenitieRow> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final amenities = eventDetails?.amenities ?? [];
